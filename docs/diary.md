...
After about a few hours of looking into .NET and what framework to actually use - like ASP.NET, I decided to put this off until I complete the front end with what will probably be with flask.